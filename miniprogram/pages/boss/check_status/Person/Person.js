// miniprogram/pages/boss/check_status/Person/Person.js
Page({
  ...
  for (var i = 0; i < daysArray.length; i++) {
    ...
    for (var j = 0; j < morning_period.length; j++) {
      ...
      if (set[daysArray[i].dateall + morning_period[j]]) {
        push_in.push({ time: daysArray[i].dateall + morning_period[j], available: false, xyname: set[daysArray[i].dateall + morning_period[j]], weekName: daysArray[i].weekName })
      }
      else {
        push_in.push({ time: daysArray[i].dateall + morning_period[j], available: true, xyname: '..', weekName: daysArray[i].weekName })
      }
    ...
    for (var j = 0; j < afternoon_period.length; j++) {
      ...
      if (set[daysArray[i].dateall + afternoon_period[j]]) {
        push_in.push({ time: daysArray[i].dateall + afternoon_period[j], available: false, xyname: set[daysArray[i].dateall + afternoon_period[j]], weekName: daysArray[i].weekName })
      }
      else {
    ...
    for (var j = 0; j < night_period.length; j++) {
      ...
      if (set[daysArray[i].dateall + night_period[j]]) {
        push_in.push({ time: daysArray[i].dateall + night_period[j], available: false, xyname: set[daysArray[i].dateall + night_period[j]], weekName: daysArray[i].weekName })
      }
      else {
